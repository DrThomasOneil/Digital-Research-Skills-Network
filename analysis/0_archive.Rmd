...
#content <- read.csv("C:/1_Yc/analysis-user-group_local/analysis/0_content management.csv")
htmltools::browsable(
  table <- reactable(content,
                     ...
                     columns = list(
                       ...
                       Activity = colDef(name = "Activity", width = 80,
                                         filterable = TRUE),
                       Title = colDef(name = "Title", width = 300,
                                      filterable = TRUE),
                       Link = colDef(name = "Link",
                                     ...
                                     cell = function(value){
                                       ...
                                       tags$a(href = value, target = "_blank", class = "page-link", 
                                              ifelse(is.na(value)|| value == ""||is.null(value), "Not available", "View page"))
                                     },
                                     width = 100),
                       Recording = colDef(name = "Recording",
                                          html = TRUE,
                                          cell = function(v){
                                            tags$a(href = v, target = "_blank", class = "video-link", 
                                                   ifelse(is.na(v)|| v == ""||is.null(v), "Coming soon", "View video"))
                                          },
                                          width = 100)
                     ),
